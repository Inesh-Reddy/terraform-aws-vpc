...
output "vpc_secondary_cidr_blocks" {
  ...
  value       = compact(module.vpc.vpc_secondary_cidr_blocks)
}
...
output "private_subnets_ipv6_cidr_blocks" {
  ...
  value       = compact(module.vpc.private_subnets_ipv6_cidr_blocks)
}
...
output "public_subnets_ipv6_cidr_blocks" {
  ...
  value       = compact(module.vpc.public_subnets_ipv6_cidr_blocks)
}
...
output "outpost_subnets_cidr_blocks" {
  ...
  value       = compact(module.vpc.outpost_subnets_cidr_blocks)
}

output "outpost_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of outpost subnets in an IPv6 enabled VPC"
  value       = compact(module.vpc.outpost_subnets_ipv6_cidr_blocks)
}
...
output "cgw_ids" {
  ...
  value       = [for k, v in module.vpc.cgw_ids : v.id]
}

output "cgw_arns" {
  description = "List of ARNs of Customer Gateway"
  value       = [for k, v in module.vpc.cgw_ids : v.arn]
}
