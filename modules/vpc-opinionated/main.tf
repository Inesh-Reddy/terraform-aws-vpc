...
module "vpc_endpoints" {
  ...
  security_group_ids = [aws_security_group.generic[0].id]

  /* This block creates vpc endpoint configuration blocks, control it via endpoints.yaml file and
     read the README for more information regarding VPC Endpoints. */
